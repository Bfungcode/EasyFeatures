  ...
  return (
    <div className='main'>
      <div className="container">
        ...
        <div className={`panel ${card4 ? "active" : ""}`} style={{ backgroundImage: `url(https://images.unsplash.com/photo-1551009175-8a68da93d5f9?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1351&q=80)` }}
          onClick={() => {
            setCard1(false);
            setCard2(false);
            setCard3(false);
        ...
        <div className={`panel ${card5 ? "active" : ""}`} style={{ backgroundImage: `url(https://images.unsplash.com/photo-1549880338-65ddcdfd017b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80)` }}
          onClick={() => {
            setCard1(false);
            setCard2(false);
            setCard3(false);
